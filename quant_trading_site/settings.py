...
MARKET_RANKINGS_DAILY_WINDOW_1MO = int(os.environ.get("MARKET_RANKINGS_DAILY_WINDOW_1MO", 30))
MARKET_RANKINGS_DAILY_WINDOW_6MO = int(os.environ.get("MARKET_RANKINGS_DAILY_WINDOW_6MO", 130))
...
CELERY_TASK_ALWAYS_EAGER = os.environ.get("CELERY_ALWAYS_EAGER", "0") in {
    "1",
    "true",
    "True",
}
...
if ENABLE_MARKET_RANKINGS_BEAT:
    CELERY_BEAT_SCHEDULE.setdefault(
        "market_rankings_snapshot_refresh",
        {
            "task": "trading.tasks.refresh_market_snapshot_rankings",
            "schedule": MARKET_RANKINGS_REFRESH_SECONDS,
        },
    )
...
MARKET_CHART_STORE_MAX_TRADES = int(os.environ.get("MARKET_CHART_STORE_MAX_TRADES", 60000))
MARKET_CHART_STORE_MAX_AGE_SECONDS = int(os.environ.get("MARKET_CHART_STORE_MAX_AGE_SECONDS", 30 * 60))
